          ...
          <div>
            ...
            <div className="flex space-x-2">
              <input
                ...
                onChange={(e) => onFilterChange({
                  timeFrame: { ...filters.timeFrame, start: e.target.value ? new Date(e.target.value) : null }
                })}
              />
              <input
                type="date"
                className="flex-1 px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                onChange={(e) => onFilterChange({
                  timeFrame: { ...filters.timeFrame, end: e.target.value ? new Date(e.target.value) : null }
                })}
              />
            </div>
          </div>
